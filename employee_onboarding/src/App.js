...
function App() {
  return (
    <section className='h-[80vh] w-screen flex flex-col justify-center items-center'>
      <svg xmlns="http://www.w3.org/2000/svg" width="140" height="24" fill="none" viewBox="0 0 140 24" className="AuthLayout_Logo__cN2A9" role="img" aria-hidden="false">
      ...
      <p className='mt-3' >Employee Onboarding Application</p>
      <form className='bg-white p-6 rounded-lg shadow-md w-[26rem] mt-10'>
        ...
        <p className='text-red-500 mb-2 text-center'> invalid Credentials </p>
        
        <button
          type='submit'
          className='w-full p-3 bg-blue-600 text-white rounded-sm hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500'
        >
          Submit
        </button>
      </form>
